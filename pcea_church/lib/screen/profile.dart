      ...
      if (res.statusCode == 200) {
        ...
        if ((body['status'] ?? 200) == 200) {
          ...
          final fetchedProfile = MemberProfile(
            ...
            eKanisaNumber: (m['e_kanisa_number'] ?? prefs.getString('e_kanisa_number') ?? '') as String,
          ...
          await prefs.setString(
            'member_profile',
            jsonEncode(fetchedProfile.toJson()),
          );
          if (fetchedProfile.imageUrl.isNotEmpty) {
            await prefs.setString('profile_image_url', fetchedProfile.imageUrl);
          }
        }
      }
    } catch (_) {
